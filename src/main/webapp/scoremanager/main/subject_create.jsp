		...
		<section>
			...
			<form action="SubjectCreateExecute.action" method="get">
				...
				<div>
					...
					<input class="form-control" type="text" id="cd" name="cd" value="${cd }" required minlength="3" required maxlength="10" placeholder="科目コードを入力してください" />
				</div>
			...
			<a href="SubjectList.action" class="me-3">戻る</a>
		</section>
	</c:param>
</c:import>